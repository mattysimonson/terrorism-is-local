...
\begin{table}[htbp]
   \caption{\label{tab:con_3} Frequentist models with ideology interactions (conservative defined as 4 or higher where 1 is `extremely liberal' and 7 is `extremely conservative')}
   \centering
